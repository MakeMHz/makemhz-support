...
Part of the XboxHDMI is the software side and it has its own guide [here](/archives/xbox-hdmi/software/xboxhdmi). Make sure to follow the guide and verify the installation of the software and kernel patch before continuing.

### Step 2 - QSB Installation
Xbox revisions 1.0 and 1.1 (Single row power supply connector and Conexant encoder) requires the installation of a QSB board. Follow the [Installation Manual QSB](/archives/xbox-hdmi/installation/qsb) first before continuing. (If you received a kit without the QSB and need one then contact support@makemhz.com or purchase one from [MakeMHz.com](https://makemhz.com))
