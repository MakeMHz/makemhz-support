...
Follow the [Installation Manual QSB HD+](/archives/xbox-hdmi/installation/qsb-hd) first before continuing.
...
Part of the XboxHD+ is the software side and it has its own guide [here](/archives/xbox-hdmi/software/xboxhd). Make sure to follow the guide and verify the installation of the software and kernel patch before continuing.
