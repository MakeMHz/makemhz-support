...
:::caution
All Xbox revisions (1.0 - 1.5) require the installation of a QSB board. Follow the [XboxHD+ QSB Installation Guide](/stellar-xboxhd/installation/qsb-hd) first before continuing.
:::
