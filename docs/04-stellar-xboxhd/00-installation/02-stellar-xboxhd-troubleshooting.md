...
### Step 1
Basic QSB verification and troubleshooting can be found in the [XboxHD+ QSB installation guide](/stellar-xboxhd/installation/qsb-hd#verificationtroubleshooting).
